...
var title = "Woman Hollering Creek";
var pages = 165;
...
var books = ["The House on Mango Street", "Their Eyes Were Watching God", "The Four Agreements", "The Body Keeps the Score", "Surfacing"];
...
var belowTwoHundred = [0, 3, 15, 199.99, -2];
...
// I ran console.log(dictionary.pageCount); to verify this worked and console.log(dictionary) to see the change made to the entire object.
